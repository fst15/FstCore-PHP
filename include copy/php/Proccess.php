...
class Proccess
{
    ...
    function client()
    {
        $json = $this->config_core->check_useragent();
    ...
    public function check_ip_info($ip = null)
    {
        ...
        $json = $this->config_core->ip_info($ip);
        $whois_json = $this->config_core->check_whois($ip);
    ...
    public function check_port($host, $port)
    {
        ...
        $this->config_core = new Lib();
        $json = $this->config_core->check_port($host, $port);
        echo '<div class="col">
        <div class="border-app">
        <table class="table table-content">
        <tr>
    ...
    public function check_whois($domain)
    {
        ...
        $this->config_core = new Lib();
        $json = $this->config_core->check_whois($domain);
        echo '<div class="col">
        <div class="row">
        <div class="col">
        <div class="border-app">
    ...
    public function check_dns_lookup($domain, $resolver, $dns_type)
    {
        ...
        $this->config_core = new Lib();
        $json = $this->config_core->check_dns_lookup($domain, $resolver, $dns_type);
        if (sizeof($json) <= 0) {
            echo $this->theme->error('data_notfound');
            exit;
        } else {
    ...
    public function check_ping($host){
        ...
        $this->config_core = new Lib();
        $json = $this->config_core->check_ping($host);
        echo '';
    }
