...
class scripts{
    ...
    {
        echo '<script async src="https://www.googletagmanager.com/gtag/js?id=G-NWYBQF8CZV"></script>
        <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag(\'js\', new Date());
    
        gtag(\'config\', \'G-NWYBQF8CZV\');
        </script>
        
        <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-6398750084433843" crossorigin="anonymous"></script>
